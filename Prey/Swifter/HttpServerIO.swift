...
public class HttpServerIO {
    ...
    public func start(_ port: in_port_t = 8080, forceIPv4: Bool = false, priority: DispatchQueue.GlobalQueuePriority = DispatchQueue.GlobalQueuePriority.background) throws {
    //public func start(_ port: in_port_t = 8080, forceIPv4: Bool = false, priority: DispatchQoS.QoSClass = DispatchQoS.QoSClass.background) throws {
        ...
        DispatchQueue.global(priority: priority).async { [weak self] in
