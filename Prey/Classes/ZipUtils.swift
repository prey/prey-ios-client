...
enum ZipBuilder {
    private static let lfhSignature: UInt32 = 0x0403_4B50
    private static let cdfhSignature: UInt32 = 0x0201_4B50
    ...
    private static func crc32(_ data: Data) -> UInt32 {
        ...
        for b in data {
            let idx = Int((crc ^ UInt32(b)) & 0xFF); crc = (crc >> 8) ^ table[idx]
        }
